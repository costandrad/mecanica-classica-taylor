...
\setlist[enumerate,1]{leftmargin=*, resume, label=\textbf{\chapternumber.\arabic*}}
...
% Vetores unitários
\newcommand{\ux}{\vet{\hat{x}}}
\newcommand{\uy}{\vet{\hat{y}}}
\newcommand{\uz}{\vet{\hat{z}}}
...
\newcommand{\makeheader}{
  ...
  \begin{minipage}[c]{4cm}
    \begin{flushright}
      \includegraphics[width=0.8\linewidth]{../assets/img/cover.png}    
    \end{flushright}
  \end{minipage}
  \vspace{0.25cm}
  \textcolor{mainColor}{\hrule}
